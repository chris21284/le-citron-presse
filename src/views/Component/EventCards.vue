<template>
    ...
    <div class="event-cards" v-if="eventCards.length > 0">
        <div class="slider">
            ...
            <button class="btn btn-prev" @click="onPrevBtnClicked"> <img src="@/assets/icons/arrow_left.png" alt="Left_Arrow"/> </button>
            <button class="btn btn-next" @click="onNextBtnClicked"> <img src="@/assets/icons/arrow_right.png" alt="Right_Arrow"/> </button>
...
<script>
    ...
    import EventSingleCard from "@/views/SingleElement/EventSingleCard.vue";
    ...
    export default {
        ...
        methods: {
            ...
            initSlideShow() {
                ...
                this.imgSelectorElement.src = require("@/assets/icons/lemon_icon.png");
...
<style>
    ...
    .event-cards .slider .pagination .nav .page-btn:hover .imgSelectorIcon {
        content: url("@/assets/icons/lemon_icon_green.png");
    }
