            ...
            <div class="more-info">
                ...
                <div class="cart-controls">
                    ...
                    <button class="addToCartBtn" @click="addToCart">
                        <img class="cart-icon" src="@/assets/v2/panier.png" alt="Panier"/>
                        AJOUTER AU PANIER
                    </button>
                </div>
...
<style>
    ...
    .allergenes ul li {
        ...
        background-image: url("@/assets/v2/lemon_icon.png");
    ...
    .allergenes ul li:hover {
        ...
        background-image: url("@/assets/v2/lemon_icon_green.png");
    }
