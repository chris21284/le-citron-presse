<template>
    <div class="devis-item" @click="redirect">
        <div class="info">
            <button class="deleteBtn" @click="deleteItem"> <img src="@/assets/icons/close_icon.png" alt="Delete" /> </button>
...
<script>
    export default {
        ...
        computed: {
            getItemPrice() { 
                if (!this.item.price) return 0; //si l'item n'a pas de prix défini?
