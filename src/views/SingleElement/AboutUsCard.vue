<template>
    <div class="about-us-card">
        <img class="bio-img" src="@/assets/icons/lemon_slice_v5.png" alt="Bio et 100% fait maison" loading="lazy"/>
        ...
        <div class="side-info">
            ...
            <div class="side-btn">
                <router-link to="/contact">
                    <button class="contact-us-btn">Contactez-nous</button>
                </router-link>
            </div>
        </div>
    </div>
...
<style scoped>
    ...
    .info p {
        font-family: ps-italic, Avenir, Helvetica, Arial, sans-serif;
        font-size: 0.93rem;
        color: var(--black);
        opacity: 0.7;
    }
